...
object maze1 {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(61); 
  ...
  val grid = new Grid(4, 4);System.out.println("""grid  : mazes1.Grid = """ + $show(grid ));$skip(35); 
  var x = BinaryTreeMaze.on2(grid);System.out.println("""x  : mazes1.Grid = """ + $show(x ));$skip(19); 
